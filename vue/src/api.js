...
const TeorUrl = "api/Teoria/"
export let Teor = apiConstructor(TeorUrl)

const PrepodUrl = "api/Prepod"
export let Prep = apiConstructor(PrepodUrl)

const FaaUrl = "api/Faa"
export let Faa = apiConstructor(FaaUrl)